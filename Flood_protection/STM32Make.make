...
GCC_PATH="C:/USERS/KUS/FILES/NEEDED_SOFTWARE/GCC-ARM-NONE-EABI-10-2020-Q4-MAJOR/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/KUS/FILES/NEEDED_SOFTWARE/OPENOCD-20210625-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/KUS/FILES/NEEDED_SOFTWARE/OPENOCD-20210625-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f3x mass_erase 0; exit"
